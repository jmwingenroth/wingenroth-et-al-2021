...
fitdata %>%
  ggplot(aes(x = Re, y = k_t, ymin = k_t - dk_t, ymax = k_t + dk_t, color = as.character(round(ad,4)))) +
...
final %>%
  ggplot(aes(x = Re, y = k_s, ymin = k_s - dk_s, ymax = k_s + dk_s, color = as.character(round(ad,4)))) +
  geom_line(lty = "dotted", size = 2, alpha = .3) + 
  geom_point(position = position_dodge(width = 10)) +
  geom_errorbar(width = 10, position = "dodge") +  
  scale_color_manual(values = c("black","blue","green","red")) +
...
final %>%
  filter(dowel_density != "0000") %>%
  ggplot(aes(x = Re, y = k_c, ymin = k_c - dk_c, ymax = k_c + dk_c, color = as.character(round(ad,4)))) +
  geom_line(lty = "dotted", size = 2, alpha = .3) + 
  geom_point(position = position_dodge(width = 10)) +
  geom_errorbar(width = 10, position = "dodge") +  
...
final %>%
  ...
  ggplot(aes(x = ad, y = eta, ymin = eta - deta, ymax = eta + deta, color = as.character(round(ad,4)))) +
  geom_line(lty = "dotted", size = 2, alpha = .3) + 
  geom_point() +
  geom_errorbar() +  
  scale_color_manual(values = c("blue","green","red")) +
