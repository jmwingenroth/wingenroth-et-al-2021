...
rm(fits, pump, pumpdata, tidypump, tidytrap, trap, trapdata, x, estimates, flow, pumpdate, pumpfiles, t_0, t_b, t_f, time, trapdate, trapfiles, poly_fin_integr)
...
Or, expressed for $k_s$, $$k_s = \frac{m_s}{m_0}(1-e^{-kT})k_{tot}$$
...
- i did find a way to propogate error through these calculations quite easily
