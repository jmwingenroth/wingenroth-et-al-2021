...
%not sure what to call this subsection 
...
Velocity measurements were also used to estimate bed shear stress. Biron et al. (2004) describes three different methods of estimating bed shear stress from Reynolds stress, TKE, and a modified turbulence kinetic energy, in which only fluctuations in the vertical direction are taken into account.%TODO
