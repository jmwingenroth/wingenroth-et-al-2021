...
\centering
\caption{Conceptual diagram of the laboratory flume. Labeled parts are: 1) pump, 2) magnetic flowmeter, 3) test section, and 4) honeycomb flow collimator. Arrows indicate direction of flow. A side view of the open-channel part of the system is included. Some dimensions not to scale. The locations of the sediment traps are marked on the top view of the diagram with red circles and on the side view with black cylinders.}
\label{fig:floorplan}
\end{figure}
