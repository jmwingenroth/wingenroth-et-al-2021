...
\caption{Estimates of effective capture efficiency calculated from experimental runs with varying degrees of biofilm growth. Colors represent the different collector densities, expressed as solid volume fraction ($\phi_c$). The shaded areas represent linear interpolations of the 95\% confidence intervals calculated from our experiments.}
\label{fig:biofilm}
\end{figure}   
