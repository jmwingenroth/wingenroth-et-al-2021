...
\caption{Estimates of effective capture efficiency calculated from experimental runs with varying degrees of biofilm growth. Colors represent the different collector densities, expressed as solid volume fraction ($\phi_c$). The shaded areas were interpolated from 95\% confidence intervals calculated from our suspended sediment time-decay experiments.}
\label{fig:biofilm}
\end{figure}   
