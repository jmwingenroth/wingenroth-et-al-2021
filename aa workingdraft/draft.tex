...
\noindent where $C$, $a$, and $b$ are empirically determined regression coefficients, and $R$ is the ratio between $d_p$ and $d_c$. They used an isolated single cylinder coated with grease, for which retention was assumed to be complete ($p_r = 1$), and yielded a model,
