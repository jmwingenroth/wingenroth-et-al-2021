...
\midrule
Particle type
& Walnut shell flour  & Road dust  & Pliolite\textsuperscript{\textregistered}   & --- \\ 
Specific gravity      
...
\vspace{2mm}
\footnotesize \item[2] Fauria et al. (2015) used a LISST to measure collection across a broad range of particle diameters (1.25--250 \SI{}{\micro\metre})
\end{tablenotes}
\end{threeparttable}
\end{table}
