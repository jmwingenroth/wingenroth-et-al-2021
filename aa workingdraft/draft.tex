...
\begin{table}[H]
\caption{Experimental and natural parameter ranges. Natural values are approximations from other studies \cite{Nepf_2012,kadlec1990, czuba2015sedgravity}. Asterisk marks where empirical estimates \cite{mckenzie2008size} replace missing study-specific data.}
\centering
...
\midrule
%Particle type
%& ground walnut shell  & road dust  & Pliolite    & e.g., silt, clay \\ 
Specific gravity      
& 1.53        &2.27--2.61*  & 1.03        & 2.56--2.87   \\
Particle diameter (\SI{}{\micro\metre})     
& 1.53        &1.25--250  & 212--250        &    \\
