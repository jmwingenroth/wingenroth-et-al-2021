...
\begin{table}[H]
\caption{Experimental and natural parameter ranges. Natural values are approximations based on field observations \cite{Nepf_2012}.}
\centering
...
\midrule
Flow velocity (\SI{}{\centi\metre/\second})     & 2.0--6.0 & 1.8--6.1 & 1.0--10.2 & 0--25     \\
Flow depth (\SI{}{\centi\metre})                & 40       & 14--17   & 12        & 0--50     \\
Average collector diameter (\SI{}{\centi\metre})& 0.318    & 0.3      & 0.63      & 0.1--1    \\
